...
public class JStatementInsertUpdate extends JPreparedStatement
{

    public JStatementInsertUpdate(JSDBCollection pCollection) throws JSDBException{
        super( pCollection );
    }
    ...
    {
        String sqlString = "INSERT OR REPLACE INTO " + mCollection.getName() + "(" + mCollection.getKeyList() + ") VALUES (" + mCollection.buildPrepareParameters() + ");";
        return sqlString;
    }
